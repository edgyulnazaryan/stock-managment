    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('resources_store') }}">
                        @csrf
                        ...
                        <div class="form-group row">
                            <label for="=qty_stock" class="col-md-4 col-form-label text-md-right">{{ __('Quantity in stock') }}</label>
                                <div class="col-md-6">
                                    <input id="qty_stock" type="number" class="form-control @error('qty_stock') is-invalid @enderror" name="qty_stock" value="{{ old('qty_stock') }}" required autocomplete="qty_stock" autofocus>
                                    @error('qty_stock')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
