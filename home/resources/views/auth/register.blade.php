                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="location_id" type="number" class="form-control" name="location_id" required autocomplete="location_id">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="type_id" type="number" class="form-control" name="type_id" required autocomplete="type_id">
                            </div>
                        </div>
